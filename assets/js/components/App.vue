<template>
    <div id='app'>
        <div class='background'>
            <div class='bg-number-wrapper'><svg id="bg-number" data-name="BG Number" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 721.2 434.4"><defs></defs><path fill="rgb(26,38,59)" class="cls-1" d="M334.8,295.2c0,74.4-54.6,139.2-174.6,139.2-58.2,0-119.4-16.2-160.2-45L38.4,315c31.8,24,75.6,37.8,119.4,37.8,48.6,0,78.6-20.4,78.6-54.6,0-33-21.6-54.6-97.8-54.6H31.2L52.8,7.2H309v78H133.8L127.2,165h34.2C285.6,165,334.8,220.8,334.8,295.2Z"/><path fill="rgb(26,38,59)" class="cls-1" d="M721.2,294.6c0,85.8-70.21,139.8-159,139.8-115.8,0-187.8-72.6-187.8-208.2C374.4,81,462,0,588.6,0c44.4,0,87.6,10.2,117,28.8l-36,71.4c-23.4-15.6-50.4-21-78.6-21-70.2,0-115.2,41.4-118.2,121.8,24.6-24.6,60-37.2,103.8-37.2C657.59,163.8,721.2,215.4,721.2,294.6ZM627,299.4c0-38.4-28.2-63-71.4-63-42.6,0-72.6,26.4-72.6,63,0,36,27,62.4,73.8,62.4C598.19,361.8,627,337.8,627,299.4Z"/></svg></div>
            <div class='bg-waves-wrapper'><svg xmlns="http://www.w3.org/2000/svg" width="" height="630" viewBox="0 0 659.599 345.132"><path fill="rgb(26,38,59)" fill-rule="evenodd" d="M1.59868732 65.13172661c-19.04350395 135.86790413 137.37365819 72.87585634 186 127 48.6263418 54.12414366 0 95 64 122s83.04409169-28.16946484 204-27c120.9559083 1.16946484 204 58 204 58l-52-297s-586.95649606-118.86790413-606 17z"/></svg></div>
            <div class='bg-dots-wrapper'><svg xmlns="http://www.w3.org/2000/svg" width="130" height="129" viewBox="0 0 130 129">
                <defs>
