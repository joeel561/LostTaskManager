       ...
       <div class="auth-form">
            <div class='auth-form-wrapper'>
                <h2 class="text-center">Register</h2>
                    <b-alert v-model="showDismissibleAlert" variant="danger" class='mb-4' dismissible>
                ...
                <b-form @submit="onSubmit" v-if="show">
                    ...
                    <div class="form-group col-md-12">
                        <b-form-input v-model="form.email" type='email' placeholder="E-Mail" required></b-form-input>
